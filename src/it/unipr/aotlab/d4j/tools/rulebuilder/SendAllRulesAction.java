...
/**
 * Action that enables the GUI to send all the rules to another agent.
 *
 ...
 *
 * @version $Id: SendAllRulesAction.java,v 1.4 2004/10/06 23:12:05 mic Exp $
 */
public class SendAllRulesAction extends AbstractAction {

    private RuleBuilderGui ownerFrame = null;
    private RuleBuilderAgent ownerAgent = null;

    public SendAllRulesAction(RuleBuilderAgent agent, RuleBuilderGui owner, String name) {
        super(name, GuiProperties.getIcon("SendAllRulesActionIcon"));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        jade.util.leap.List rulesList = ruleSet.getRules();
