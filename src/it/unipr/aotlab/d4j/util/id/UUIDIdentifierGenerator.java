...
package it.unipr.aotlab.d4j.util.id;
 ...
 * </li>
 * <li>
 * 3) (17-24 hex characters) the hex value of this
 ...
 * <li>3) A reset clock will produce an identical hashcode for the new deployment
 * as a previous one AND the random values will have to be the same in the same repeated
 * millisecond value as in a previous sequence.
 * </li>
 * </ul>
 *
 * @author <a href="www.activescript.co.uk">Steve Woodcock</a>
 * @version $Id: UUIDIdentifierGenerator.java,v 1.1 2004/10/01 18:39:38 mic Exp $
 */
